...
const ZH_CN: TuiCopy = {
  ...
  composer: {
    placeholder: "告诉 Novel Creation 要写什么、修改什么，或解释什么…",
    emptyConversation: "先告诉 Novel Creation 你要做什么。",
...
const EN: TuiCopy = {
  ...
  composer: {
    placeholder: "Ask Novel Creation to write, revise, or explain…",
    emptyConversation: "Start by asking Novel Creation what to do.",
