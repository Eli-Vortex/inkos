          ...
          <div className="space-y-2">
            {models.length > 0 ? (
              <div className="flex gap-1.5 flex-wrap">
                {models.map((m) => (
                  <span key={m.id} className="inline-flex items-center gap-1 text-[11px] px-2.5 py-1 rounded-md bg-success/[0.06] text-success dark:text-success border border-success/30">
                    {m.name ?? m.id}
                    <button
                      type="button"
