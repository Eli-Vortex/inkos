...
const strings = {
  ...
  "nav.createPlay": { zh: "Novel Creation 互动", en: "Novel Creation Play" },
  ...
  "nav.workbench": { zh: "Novel Creation", en: "Novel Creation" },
  "nav.wbBooks": { zh: "作品列表", en: "Works" },
  "nav.wbWriting": { zh: "写作工作区", en: "Writing Workspace" },
  "nav.wbOutline": { zh: "细纲与合同", en: "Outline & Contract" },
  "nav.wbReview": { zh: "审核视图", en: "Review" },
  "nav.wbCompare": { zh: "版本比较", en: "Compare Versions" },
  "nav.wbCommit": { zh: "提交确认", en: "Commit" },
  "nav.wbTasks": { zh: "任务中心", en: "Tasks" },
  "nav.wbResearch": { zh: "研究与分析", en: "Research" },
  "nav.wbAnalytics": { zh: "连载分析", en: "Serial Analytics" },
  "nav.wbExport": { zh: "导出", en: "Export" },
  "nav.wbSettings": { zh: "设置与关于", en: "Settings & About" },
  ...
  "doctor.projectEnv": { zh: "项目环境变量", en: "Project environment" },
  "doctor.globalEnv": { zh: "全局环境变量", en: "Global environment" },
  ...
  "chapter.cardGenerated": { zh: "已生成细纲", en: "Card Generated" },
  "chapter.drafting": { zh: "生成中", en: "Drafting" },
  "chapter.auditing": { zh: "审核中", en: "Auditing" },
  "chapter.auditPassed": { zh: "审核通过", en: "Audit Passed" },
  "chapter.stateDegraded": { zh: "状态异常", en: "State Degraded" },
