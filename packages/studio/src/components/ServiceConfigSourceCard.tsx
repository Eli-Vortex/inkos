...
export function ServiceConfigSourceCard({ onChange }: { onChange?: () => void }) {
  ...
  if (!data) {
    return (
      <div className="rounded-xl border border-warning/35 bg-warning/[0.04] p-4 text-sm text-warning">
  ...
  return (
    <div className="rounded-xl border border-border/40 bg-card/70 p-4 space-y-3">
      ...
      {storedConfigSource === "env" ? (
        <div className="rounded-lg border border-warning/35 bg-warning/[0.04] p-3 text-xs text-muted-foreground/80">
          {tr(
      ...
      {envDetected ? (
        <div className="rounded-lg border border-warning/35 bg-warning/[0.04] p-3 text-xs text-muted-foreground/80 space-y-1.5">
