...
function RiskPills({ risks, zh }: { risks: readonly ForecastRisk[]; zh: boolean }) {
  if (risks.length === 0) {
    return (
      <span className="inline-flex items-center gap-1 rounded-full border border-success/30 bg-success-soft px-2 py-0.5 text-[11px] text-success dark:text-success">
        <ShieldCheck size={11} />
    ...
    <div className="flex flex-wrap gap-1.5">
      {risks.map((risk, index) => (
        <span
          ...
          className="inline-flex items-center rounded-full border border-warning/35 bg-warning-soft px-2 py-0.5 text-[11px] text-warning dark:text-warning"
        >
  ...
  return (
    <section className="mx-3 mb-3 mt-1 overflow-hidden rounded-2xl border border-primary/25 bg-[linear-gradient(145deg,hsl(var(--card))_0%,hsl(var(--muted)/0.32)_100%)]">
      <header className="border-b border-border/45 px-4 py-3.5">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              ...
              {stale && (
                <span className="inline-flex items-center gap-1 rounded-full border border-warning/35 bg-warning-soft px-2 py-0.5 text-[10px] font-medium text-warning dark:text-warning">
        ...
        {stale && (
          <div className="mt-3 flex items-start gap-2 rounded-lg border border-warning/35 bg-warning-soft px-3 py-2 text-xs leading-5 text-warning dark:text-warning">
