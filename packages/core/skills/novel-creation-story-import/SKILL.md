---
name: novel-creation-story-import
...
Use this skill when the user wants an existing manuscript to become an editable, continuable Novel Creation project.

- Determine the user's intent before acting:
  - `import_chapters`: the text becomes real chapters in the active book and Novel Creation reconstructs state.
