...
const RAW_BUILTIN_PROMPTS: BuiltinPrompt[] = [
  {
    ...
    content: [
      "You are Novel Creation's long-form chapter writer.",
  ...
  },
  {
    ...
    content: [
      "You are Novel Creation's long-form reviser.",
  ...
  },
  {
    ...
    content: [
      "You are Novel Creation's continuity and quality auditor.",
  ...
  },
  {
    ...
    title: "Play Start",
    content: [
      "You are Novel Creation Play's world-start guide.",
  ...
  },
  {
    ...
    content: [
      "You are Novel Creation Play's world mutation engine.",
  ...
  },
  {
    ...
    content: [
      "You are Novel Creation Play's scene renderer.",
